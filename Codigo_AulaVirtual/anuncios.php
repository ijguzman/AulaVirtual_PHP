		...
		<ul id="side-nav" class="main-menu navbar-collapse collapse">
			...
			<li class="has-sub"><a href="anuncios.html"><i class="icon-info"></i><span class="title">Anuncios</span></a>
				<ul class="nav collapse">
					...
					<li><a href="modificar_anuncio.php"><span class="title">Modificar anuncios</span></a></li>
							...
							<div class="panel panel-default animated fadeInUp">
								<div class="panel-body">
									...
									<ul class="comments-list removeable-list">
										<li>
											<form method="post" action="crearanuncio.php"> 
...
<tr>
 ...
 <id="combo" name="combo" action="guardaanuncio.php" method="POST">
			<div> <select name="cbx_curso" id="cbx_curso">
        <?php
          include 'dbconnection.php';
          ...
          $res = $mysqli->query($select_rol);
                while($row = $res->fetch_object()){
                    echo "
                        <option value='".$row->COD_CURSO."'></option>";
                }
        echo '  </select>';
...
<tr>
 ...
 <td valign="top">
  <textarea  name="descripcion" maxlength="1000" cols="25" rows="6"></textarea>
 </td>
</tr>
<tr>
