...
<script>
	...
	<?php
          ...
          echo '<h4><b>Seleccionar Plantilla:</b> 
          <select id="lista_plantillas" name="plantillas">';
          for($i=0;$i<$n;$i++){
            echo "<option id='opcion_plantillas' value='".$plantillas["id"][$i]."'>".$plantillas["nombre"][$i]."</option>";
          }
          echo '  </select>';
          echo "</h4>";

          echo '<h4><b>Seleccionar Medio:</b>
          <select id="lista_medios" name="medios">';
          for($i=0;$i<$n1;$i++){
            echo "<option id='opcion_medios' value='".$medios["id"][$i]."'>".$medios["nombre"][$i]."</option>";
          }
          echo '  </select>';
          echo "</h4>";
                    ...
                    <div class="panel-body">
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered table-hover dataTables-example" >
                                ...
                                <tbody>';
                                $select_alumnos="SELECT A.COD_ALUMNO AS CODIGO,A.NOMBRES AS NOMBRES,A.APELLIDOS AS APELLIDOS FROM auv_alumno A,auv_alumno_curso CA WHERE A.COD_ALUMNO=CA.COD_ALUMNO AND CA.COD_CURSO='".$curso."';";
                                
                                $res_1 = $mysqli->query($select_alumnos);
                                //echo $mysqli->error;
                                while($row = $res_1->fetch_object()){
                                    echo '<tr id="fila">';
                                    echo '<td id="columna">'.$row->CODIGO.'</td>';
        ...
        <input type="hidden" value="'.$curso.'" name="Nrc"/> 
