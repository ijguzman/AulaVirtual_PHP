  ...
  <div class="main-container gray-bg">
		...
		<!-- /main header -->
                                ...
                                <div class="portlet-title">
                                    ...
                                    <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                                        <thead>
											...
											<?php
							$sql_anuncios="SELECT DESCRIPCION, FECHA FROM auv_anuncio
							WHERE COD_ANUNCIO=".$anuncio.";";											
							$result=$mysqli->query($sql_anuncios);
							while($mostrar=$result->fetch_object()){
			...
			echo '<form action="insert_anuncio.php" method="POST">
				...
				<td><input type="text" value= "'.$mostrar->DESCRIPCION.'" size="40" maxlength="80"name="descripcion"> </td>
				
				<td><input type="date" value= "'.$mostrar->FECHA.'" name="fecha"></td>
				<td><input type="submit" value="Registrar cambios">
				<a class="btn btn-primary" class="btn btn-primary" href="borrar_anuncio.php?id='.$anuncio.'"><i 
