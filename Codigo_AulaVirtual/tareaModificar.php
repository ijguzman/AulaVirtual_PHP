...
<div class="page-container">
	...
	<div class="page-sidebar">
		...
		<ul id="side-nav" class="main-menu navbar-collapse collapse">
			...
			<li class="has-sub"><a href="tarea.html"><i class="icon-info"></i><span class="title">Tareas</span></a>
				<ul class="nav collapse">
					<li><a href="tarea.php"><span class="title">Crear Tareas</span></a></li>
					<li><a href="tarea.php"><span class="title">Modificar Tareas</span></a></li>
					<li><a href="tarea.php"><span class="title">Visualizar Tareas</span></a></li>
  ...
  <div class="main-container gray-bg">
		...
		<!-- /main header -->
							   ...
							   <?php
							include 'dbconnection.php';
							$sql="SELECT * FROM auv_tarea WHERE COD_TAREA='$cod_tarea'";
                                  ...
                                  <h2>Modificar Tareas</h2>
                                    <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
										...
										<?php
											...
											$sql_tareas="SELECT FA.COD_TAREA,A.NOMBRES,A.APELLIDOS FROM auv_tarea FA,auv_alumno A
											WHERE FA.COD_ALUMNO=A.COD_ALUMNO AND FA.COD_TAREA=".$cod_tarea.";";											
											$result=$mysqli->query($sql_tareas);
											while($mostrar=$result->fetch_object()){
												echo "<tr>";
												echo "<td>".$mostrar->TEMA."</td>";
												echo "<td>".$mostrar->DESCRIPCION."</td>";
												echo "<td>".$mostrar->FECHA_INICIO."</td>";
												echo "<td>".$mostrar->FECHA_FIN."</td>";
												echo "</tr>";
											}
											?>
